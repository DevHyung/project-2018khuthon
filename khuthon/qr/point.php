            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mt-5">
                        <form method="POST" action="../db/qr_modify_point.php">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title"><?=$_SESSION['u_name'];?>님 정보</h4>    
                                    ...
                                    <div class="form-group">
                                            <label for="usingPoint" class="col-form-label">사용 포인트 입력</label>
                                            <input class="form-control" type="text" name="usingPoint" id="usingPoint">
                                    </div>

                                    
                                    <button type="submit" class="btn btn-danger btn-lg btn-block" >사용 !!</button>
                                </div>
                            </div>
                        </form>
                    </div>
